...
Serves a standalone **chat overlay** web page. It works well as a browser source in OBS or as a second-screen chat view. The page loads recent messages once, then receives new messages immediately.
