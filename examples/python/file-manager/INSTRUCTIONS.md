...
- Lists the files in the plugin's sandbox (`data/plugin-storage/file-manager/files/`).
...
written into `data/plugin-storage/file-manager/files/` on the server. Refresh
the page and you'll see it listed. Download or delete it from there.
