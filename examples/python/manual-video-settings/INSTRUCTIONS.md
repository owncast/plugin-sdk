...
A hand-edit form for the Owncast transcoding pipeline. Use it when you want to tune output settings directly without going through the standard preset UI, which is useful for one-off experiments or hardware that needs a non-default codec.
