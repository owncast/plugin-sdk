...
The interval is fixed at 2 seconds in this example, and the per-user timing is held in memory. It demonstrates *dropping* a message outright. For the opposite approach, see `profanity-filter`, which rewrites messages instead.
