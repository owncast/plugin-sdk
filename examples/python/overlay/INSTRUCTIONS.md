...
Serves a standalone **chat overlay** web page. It works as a browser source in OBS or as a second-screen chat view. The page polls the plugin for recent chat history and renders messages live.
