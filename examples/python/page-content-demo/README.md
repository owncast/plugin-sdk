...
**`on_page_content`** — called for the `"banner"` slot. Renders `assets/greeting.mustache` personalised with the viewer's display name, falling back to `"visitor"` for anonymous viewers.
