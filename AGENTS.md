...
- **[create-owncast-plugin](.agents/skills/create-owncast-plugin/SKILL.md)** is
...
- **[create-owncast-plugin-js](.agents/skills/create-owncast-plugin-js/SKILL.md)**
  ...
  are the per-language playbooks that take a plugin from scaffold to an installable
